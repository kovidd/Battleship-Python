...
def play():
    ...
    for _ in range(validate_input('Enter the number of missiles you want to fire: ')):  # Input the number of missiles to be fired
        while p1.fleet:  # Play till not all ships are destroyed
            p1.attack()
